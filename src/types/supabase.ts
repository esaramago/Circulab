  ...
  public: {
    Tables: {
      categories: {
        ...
        Relationships: [
          {
            foreignKeyName: "categories_typology_id_fkey"
            columns: ["typology_id"]
            isOneToOne: false
      ...
      characteristics: {
        ...
        Relationships: [
          {
            foreignKeyName: "characteristics_category_id_fkey"
            columns: ["category_id"]
            isOneToOne: false
      ...
      location_networks: {
        ...
        Relationships: [
          {
            foreignKeyName: "location_networks_location_id_fkey"
            columns: ["location_id"]
            isOneToOne: false
          ...
          {
            foreignKeyName: "location_networks_network_id_fkey"
            columns: ["network_id"]
            isOneToOne: false
      ...
      pins: {
        ...
        Relationships: [
          {
            foreignKeyName: "pins_category_id_fkey"
            columns: ["category_id"]
            isOneToOne: false
            referencedRelation: "categories"
            referencedColumns: ["id"]
      ...
      users: {
        Row: {
          accepted_pins_count: number | null
          email: string
          id: string
